...
с использованием LibGDX. Items Jlayground поддерживает многопользова-
тельскую игру. Автор игры — downadow.
...
## Скачивание ресурсов по сети

Игра поддерживает скачивание ресурспаков по сети. Вы можете загрузить
ресурспак _game_, поставляемый с игрой, введя [эту](https://github.com/downadow-dev/items-jlayground/raw/main/game)
ссылку в меню.
